...
switch(color)
{
  case 'red': console.log("Q1: Red's a great color on you.");
break;
    case 'blue': console.log("Q1: Blue? Great choice.");
break;
    case 'green': console.log("Q1: Ok. Green it is.");
break;
...
switch(fruit){
    ...
    case "strawberry": console.log('Q3: Mmmm...nothing better than strawberries.'); break;
...
switch(true){
    ...
    case percentageComplete==100: console.log("Q4: You're there. Well done!"); break;
}
